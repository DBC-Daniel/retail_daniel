...
#로컬에서 날리기
#databricks CLI에서 날려야함. (노트북은 X)
# dbfs cp "C:/Users/MZC01-SSLEE/Desktop/train.csv" "dbfs:/FileStore/demand_forecast/train/train.csv"

# COMMAND ----------

# MAGIC %fs ls dbfs:/FileStore/demand_forecast/train/
